 ...
 *  @return 是否创建成功
 */
- (BOOL)connectionDatabaseName:(NSString *)databaseName tableName:(NSString *)tableName column1Name:(NSString *)column1 column1Type:(NSString *)type1
...
+(BOOL)ManagerWithConnectionDatabaseName:(NSString *)databaseName tableName:(NSString *)tableName column1Name:(NSString *)column1 column1Type:(NSString *)type1
column2Name:(NSString *)column2 column2Type:(NSString *)type2
column3Name:(NSString *)column3 column3Type:(NSString *)type3
                             column4Name:(NSString *)column4 column4Type:(NSString *)type4;
/**
...
// 查询
- (NSMutableArray *)useDatabase:(NSString *)databaseName selectAllFromTable:(NSString *)tableName whereColumn1:(NSString *)column1 value1:(NSString *)value1 column2:
    (NSString *)column2 value2:(NSString *)value2;
